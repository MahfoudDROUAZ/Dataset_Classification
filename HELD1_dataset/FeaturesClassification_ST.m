...
addpath('F:\dataset\HELD1\traitement');
...
samples_ST = [ST_Features(:,4), ST_Features(:,5)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,4), ST_Features(:,5), ST_Features(:,6)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,3), ST_Features(:,4)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,3), ST_Features(:,4), ST_Features(:,5)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,3), ST_Features(:,4), ST_Features(:,5), ST_Features(:,6)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,3), ST_Features(:,9)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,3), ST_Features(:,9), ST_Features(:,10)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,3), ST_Features(:,9), ST_Features(:,10), ST_Features(:,11)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,2), ST_Features(:,4)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,2), ST_Features(:,4), ST_Features(:,5)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
...
samples_ST = [ST_Features(:,2), ST_Features(:,4), ST_Features(:,5), ST_Features(:,6)];
for i=1:It
    %ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
    ctree = fitctree(samples_ST,groups);
    cvrtree = crossval(ctree);
