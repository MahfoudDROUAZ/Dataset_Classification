...
samples_ST = [discripteurs_ST(:,3), discripteurs_ST(:,4)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,3), discripteurs_ST(:,4), discripteurs_ST(:,5)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,2), discripteurs_ST(:,3)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,2), discripteurs_ST(:,3), discripteurs_ST(:,4)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,2), discripteurs_ST(:,3), discripteurs_ST(:,4), discripteurs_ST(:,5)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,2), discripteurs_ST(:,8)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,2), discripteurs_ST(:,8), discripteurs_ST(:,9)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,2), discripteurs_ST(:,8), discripteurs_ST(:,9), discripteurs_ST(:,10)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,1), discripteurs_ST(:,3)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,1), discripteurs_ST(:,3), discripteurs_ST(:,4)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
...
samples_ST = [discripteurs_ST(:,1), discripteurs_ST(:,3), discripteurs_ST(:,4), discripteurs_ST(:,5)];
for i=1:It
%ctree = fitcknn(samples_ST,groups,'NumNeighbors',k,'Distance','euclidean');
ctree = fitctree(samples_ST,groups)
cvrtree = crossval(ctree);
